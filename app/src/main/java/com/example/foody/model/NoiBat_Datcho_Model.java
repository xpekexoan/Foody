...
public class NoiBat_Datcho_Model {
    String anh;
    int anhchamtron;
    String tieude;
    String diachi;
    ...
    public NoiBat_Datcho_Model() {
    }

    public NoiBat_Datcho_Model(String anh, int anhchamtron, String tieude, String diachi, String khoangcach, String thongtin, String cangay, String giam) {
        this.anh = anh;
